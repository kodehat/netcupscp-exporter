...
TARGET_PACKAGE='github.com/kodehat/netcupscp-exporter/internal/build'
...
echo "[Go v${go_version}] Building netcupscp-exporter in ${output} at ${BUILD_TIME} with commit ${commit_hash:-unknown} in version ${version}."
